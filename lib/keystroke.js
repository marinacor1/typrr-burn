class KeyStroke {
	...
	prepareForNext() {
		if(this.correct) {
			...
			console.log("correcttarget:", target)
			console.log("correctthis:", $this)
			...
			var $this = "#" + (this.currentIndex -1);
			var target = "#" + this.currentIndex;
			console.log("backspacetarget:", target)
			console.log("backspacethis:", $this)
			$('.letter').removeClass('grey');
			$('.letter').removeClass('underline');
			$($this).removeClass("red");
			$(target).addClass("underline");
			...
			var $this = "#" + (this.currentIndex -1);
			var target = "#" + this.currentIndex;
			console.log("wrongtarget:", target)
			console.log("wrongthis:", $this)
			$('.letter').removeClass('grey');
			$('.letter').removeClass('underline');
